...
$module_constant = 'AVERAGE_PRODUCT_REVIEWS_VERSION'; // This should be a UNIQUE name followed by _VERSION for convention
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/avg_product_reviews'; // This is the directory your installer is in, usually this is lower case
$module_name = "Average Product Reviews"; // This should be a plain English or Other in a user friendly way
$zencart_com_plugin_id = 398; // from zencart.com plugins - Leave Zero not to check
