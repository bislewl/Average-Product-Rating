...
define('TEXT_PRODUCT_NOT_FOUND', 'Omlouváme se, ale v souèasné dobì zde není žádné zboží.');
...
define('TEXT_DATE_ADDED', 'Tento produkt byl pøidán dne %s.');
define('TEXT_DATE_AVAILABLE', 'Toto zboží bude skladem dne %s.');
define('TEXT_ALSO_PURCHASED_PRODUCTS', 'Zákaznící, kteøí si koupili toto zboží, objednávali také...');
define('TEXT_PRODUCT_OPTIONS', 'Vyberte prosím: ');
...
define('IMAGE_BUTTON_PREVIOUS','Pøedchozí');
define('IMAGE_BUTTON_NEXT','Další');
define('IMAGE_BUTTON_RETURN_TO_PRODUCT_LIST','Zpìt na výbìr zboží');

// missing products
//define('TABLE_HEADING_NEW_PRODUCTS', 'Nové zboží pro %s');
//define('TABLE_HEADING_UPCOMING_PRODUCTS', 'Naše nabídka');
